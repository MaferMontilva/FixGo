...
const checkedModules = ["auth", "users", "clients", "categories", "services", "professionals", "service-requests", "administration", "artificial-intelligence", "budgets", "reviews", "service-orders", "notifications"];
