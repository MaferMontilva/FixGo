...
INSERT INTO countries (iso2, name) VALUES ('ES','España');
INSERT INTO regions (country_id,name,code) SELECT id,'Comunidad de Madrid','MD' FROM countries WHERE iso2='ES';
INSERT INTO regions (country_id,name,code) SELECT id,'Cataluña','CT' FROM countries WHERE iso2='ES';
INSERT INTO regions (country_id,name,code) SELECT id,'Comunidad Valenciana','VC' FROM countries WHERE iso2='ES';
INSERT INTO cities (region_id,name,postal_code_prefix) SELECT id,'Madrid','28' FROM regions WHERE name='Comunidad de Madrid';
INSERT INTO cities (region_id,name,postal_code_prefix) SELECT id,'Barcelona','08' FROM regions WHERE name='Cataluña';
INSERT INTO cities (region_id,name,postal_code_prefix) SELECT id,'Valencia','46' FROM regions WHERE name='Comunidad Valenciana';

INSERT INTO categories (code,name,slug,description,icon_name,sort_order) VALUES
...
INSERT INTO services (category_id,code,name,slug,description,sort_order)
...
INSERT INTO site_settings (setting_key,setting_value,value_type,is_public,description) VALUES
